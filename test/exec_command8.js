...
describe('addition-8-global', function () {
...
//=================================================================================
describe('test-Global-7', function () {
    it('test-Global-7-completed', function (done) {
                    ...
                    if (stdout != "") {
                        ...
                        if (losk_version == 'latest') {
                            for (var i = 0 ; keys.length > i ; i++) {
                                ...
                                //console.log("i - " + i + "   keys.length - " + keys.length + "   countpackege - " + countpackege);
                                //f----------------------------------------------------------
        ...
        function exec_command_save_dev(modulupdate) {
            ...
            (error, stdout, stderr) => {
                ...
                if (error !== null) {
                    ...
                    //------ test --------
                    //console.log("TEST - + save_dev   " + keys[lengmass]);
                    switch (lengmass) {
                        case 0:
                            keys[lengmass].should.equal("gulp-a");
        ...
        function exec_command_save(modulupdate) {
            ...
            (error, stdout, stderr) => {
                ...
                if (error !== null) {
                    ...
                    //------ test --------
                    //console.log("TEST - save + " + keys[lengmass]);
                    switch (lengmass) {
                        case 1:
                            keys[lengmass].should.equal("gulp-b");
                            console.log("command_save" + lengmass + "   " + keys[lengmass]);
                            break
                        case 2:
                            keys[lengmass].should.equal("gulp-c");
                            console.log("command_save" + lengmass + "   " + keys[lengmass]);
                            break
                        case 3:
